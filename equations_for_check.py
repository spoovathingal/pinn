"""Euler-equation utilities and residuals for the 1D PINN."""
...
def euler_residuals(
    ...
    """Compute mass, momentum, and energy residuals of q_t + f(q)_x = 0."""
    ...
    r_mass = gradient(q1, t) + gradient(f1, x)
    r_momentum = gradient(q2, t) + gradient(f2, x)
    r_energy = gradient(q3, t) + gradient(f3, x)
    return r_mass, r_momentum, r_energy
